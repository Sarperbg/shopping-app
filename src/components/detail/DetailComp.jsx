...
const DetailComp = ({ productDetail }) => {
  ...
  return (
    <div className='flex gap-10 my-10'>
      <img className='w-[500px] h-[500px] object-cover' src={productDetail?.image} alt='test' />
      <div className=''>
        ...
        <div onClick={addBasket} className='border w-200 text-2xl rounded-md bg-gray-200 cursor-pointer h-16 flex items-center justify-center'>Sepete Ekle</div>
      </div>
    </div>
  )
}
